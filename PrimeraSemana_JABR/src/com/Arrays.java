...
public class Arrays {
	...
	public static void main(String[] args) {
		...
		//Ej. Solo números enteros, solo decimales, solo
		...
		nombre [0] = 'A'; //dentro de los corchetes indicamos la posición
		...
		//en una sola intención y si me muestra los valores
		...
		//Podemos mandar a imprimir posición por posición si es que requerimos un elemento

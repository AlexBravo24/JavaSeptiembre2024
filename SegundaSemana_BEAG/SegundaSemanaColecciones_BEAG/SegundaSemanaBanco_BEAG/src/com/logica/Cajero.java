...
import com.servicio.IMétodos;

public class Cajero implements IMétodos {
	...
	// Generar los constructores vacío y con todos los elementos, excepto folio:
	public Cajero() {
	...
	// Lo siguiente aparece de manera automática cuando importamos
	// IMétodos y Cajero al momento de que nos subraya las palabras

...
public class Principal {
	...
	public static void main(String[] args) {
		...
		//permitir gestionar de una forma más rápida e imperativa la 
		//información que tengamos en nuestras colecciones de datos
		...
		//Una vez filtramos la información, la llevo hacia una lsita
...
//		}
		...
		//2. También podemos recuperar todos los elementos con el ciclo forEach
//		for (Persona i:original) {
//			System.out.println(i);
//		}
		
		//3. Otra opción es con un ciclo forEach pero ahora a través de nuestra lista
//		original.forEach(a -> System.out.println(a));
		
		
		//Si filtraramos a los elementos del género masculino con un ciclo convencional
//		for (Persona i:original) {
...
//		System.out.println(original.stream().count());
		...
		//Solicitar una variable boolean si algún elemento o todos los elementos 
		//cunmplen alguna condición
		//anyMatch:

...
public class ArrayBidimensional {
	...
	public static void main(String[] args) {
		...
		// Ej.- decara un array bidimensional de numeros enteros
		
		int [] [] matriz = new int [3][3]; // [filas][columnas]
		
		// Ej. de llenado de um array de dos dimensiones
		...
		// si queremos imprimir u obtener un valor de una determinada posision

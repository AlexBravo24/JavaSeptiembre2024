...
public class MetodosString {
	...
	public static void main(String[] args) {
		...
		//String es un tipo de dato objeto, por lo cual cuenta con metodos o propiedades
		//para manipular o consultar su informacion
	
		String cadena = "Hoy es 3 de Septiembre de 2024";
		
		//.length() - Nos devuelve el tamaño o longitud de la cadena en valor numerico entero
		System.out.println("probando el metodo .lenght()");
		System.out.println(cadena.length());
		//si necesitara guardar el valor de la longuitud de la cadena
		//lo puedo hacer asi 
		int longitud = cadena.length();
		System.out.println(longitud + 20);
		...
		//.equals() -Compara un objeto contra otro para decirnos si son iguales y nos
		//devuelve un valor booleano
		System.out.println("Probando el metodo .equals()");
		System.out.println(cadena.equals("hoy es 3 de septiembre de 2024"));
		
		//.equalsIgnoreCase() - Compara dos cadenas de texto pero omite el uso de mayusculas y minusculas
		//si el conenido es el mismo devuelve un valor true
		...
		//Operador Modulo - %
		//Cuando se utiliza en una operacion de division nos devuelve el valor del residuo de la operacion 
		System.out.println("Operador Modulo %");
		int division = 10 % 3; //cuando se ocupa el simbolo de porcentaje el resultado es el residuo 

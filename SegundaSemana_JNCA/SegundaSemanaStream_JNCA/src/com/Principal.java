...
public class Principal {
	...
	public static void main(String[] args) {
		...
		// API - Stream - Funcionalidad a parti de Java 8
		...
		original.add(new Persona("Guadalupe", "FEMENINO", 35));
		...
		original.add(new Persona("Grabiela", "FEMENINO", 22));

...
public class Laptop {
	...
	//Aqui declaramos como ejemplo atributos
	//que formarán parte de Laptop pero en realidad son
	//otros objetos más pequeños que la componen
	//Así que primero debo crear esas clases
	private Ram ram;
